...
Este documento contiene las observaciones de la auditoría inicial de seguridad realizada en la Fase 0 para preparar el sistema de autenticación de Alex IO hacia tokens JWT.
